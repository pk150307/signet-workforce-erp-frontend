...
export function mapPayslipDetail(raw: unknown, fallbackId?: string): PayslipDetail {
  ...
  if (employee && typeof employee === 'object') {
    ...
    return {
      ...
      softCode: pickString(emp, 'softCode', 'clientSoftCode'),
      fatherName: pickString(emp, 'fatherName') ?? null,
      ...
      esicNumber: pickString(emp, 'esiNumber', 'esicNumber'),
  ...
  return {
    ...
    designation: pickString(r, 'designation', 'designationName') ?? '',
    siteName: pickString(r, 'siteName'),
    softCode: pickString(r, 'softCode', 'clientSoftCode'),
    fatherName: pickString(r, 'fatherName') ?? list.fatherName ?? null,
