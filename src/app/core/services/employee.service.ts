...
const MOCK_EMPLOYEES: EmployeeListItem[] = [
  { id: '1', employeeCode: 'EMP-0248', softCode: 'BRG-01', fullName: 'Priya Sharma', fatherName: 'Ramesh Sharma', email: 'priya.sharma@signet.com', phone: '9876543210', department: 'Operations', designation: 'Site Supervisor', siteName: 'Tech Park Alpha', status: EmployeeStatus.Active, joiningDate: '2026-06-10', profilePhotoUrl: null },
  { id: '2', employeeCode: 'EMP-0247', softCode: 'MAL-04', fullName: 'Rajesh Kumar', fatherName: 'Suresh Kumar', email: 'rajesh.kumar@signet.com', phone: '9876543211', department: 'Security', designation: 'Security Guard', siteName: 'Mall Central', status: EmployeeStatus.Active, joiningDate: '2026-06-08', profilePhotoUrl: null },
  { id: '3', employeeCode: 'EMP-0246', softCode: 'CTB-02', fullName: 'Anita Desai', fatherName: 'Mahesh Desai', email: 'anita.desai@signet.com', phone: '9876543212', department: 'Housekeeping', designation: 'Team Lead', siteName: 'Corporate Tower B', status: EmployeeStatus.Draft, joiningDate: '2026-06-05', profilePhotoUrl: null },
  { id: '4', employeeCode: 'EMP-0245', softCode: 'IND-09', fullName: 'Mohammed Ali', fatherName: 'Imran Ali', email: 'mohammed.ali@signet.com', phone: '9876543213', department: 'Operations', designation: 'Field Executive', siteName: 'Industrial Zone', status: EmployeeStatus.Rejoined, joiningDate: '2026-06-01', profilePhotoUrl: null },
  { id: '5', employeeCode: 'EMP-0244', softCode: 'HO-01', fullName: 'Sunita Patel', fatherName: 'Kiran Patel', email: 'sunita.patel@signet.com', phone: '9876543214', department: 'Administration', designation: 'HR Coordinator', siteName: 'Head Office', status: EmployeeStatus.Active, joiningDate: '2026-05-28', profilePhotoUrl: null },
  { id: '6', employeeCode: 'EMP-0201', softCode: 'HO-03', fullName: 'Vikram Singh', fatherName: 'Ajay Singh', email: 'vikram.singh@signet.com', phone: '9876543215', department: 'Finance', designation: 'Accountant', siteName: 'Head Office', status: EmployeeStatus.Left, joiningDate: '2024-01-15', profilePhotoUrl: null },
];
