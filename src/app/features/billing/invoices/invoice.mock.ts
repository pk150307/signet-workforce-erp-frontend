...
const MOCK_INVOICES: InvoiceListItem[] = [
  { id: 'inv-001', invoiceNumber: 'INV-2026-06-001', clientName: 'Tata Realty', siteName: 'Bandra Kurla Complex', invoiceDate: '2026-06-01', dueDate: '2026-06-15', subtotal: 850000, gstAmount: 153000, totalAmount: 1003000, status: 'Pending', month: 6, year: 2026 },
...
export function getMockInvoiceDetail(id: string): InvoiceDetail {
  ...
  return {
    ...
    clientId: 'cli-001',
    siteId: 'site-001',
    billingAddress: 'Signet Workforce Services Pvt Ltd\n123 Business Park, Andheri East\nMumbai, Maharashtra 400093',
    gstNumber: '27AABCS1429B1Z5',
    notes: 'Payment terms: Net 15 days. Please reference invoice number in remittance.',
    lineItems: [
      { description: 'Security Services - June 2026', quantity: 45, rate: 12000, amount: 540000, gstRate: 18, gstAmount: 97200 },
      { description: 'Housekeeping Services - June 2026', quantity: 20, rate: 8500, amount: 170000, gstRate: 18, gstAmount: 30600 },
      { description: 'Facility Management - June 2026', quantity: 10, rate: 14000, amount: 140000, gstRate: 18, gstAmount: 25200 },
    ],
    timeline: [
      { id: 'tl-1', action: 'Created', description: 'Invoice created manually', performedBy: 'Admin User', performedAt: '2026-06-01T09:00:00Z' },
      ...
      { id: 'tl-3', action: 'Viewed', description: 'Client viewed invoice portal', performedBy: 'Client Portal', performedAt: '2026-06-02T14:15:00Z' },
    ],
  };
}
