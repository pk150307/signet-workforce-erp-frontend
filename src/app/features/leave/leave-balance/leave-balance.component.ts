...
@Component({
  ...
  styleUrl: './leave-balance.component.less',
})
export class LeaveBalanceComponent implements OnInit {
  private readonly leaveService = inject(LeaveService);
  readonly loading = signal(true);
  readonly data = signal<CursorPaginatedResult<LeaveBalance> | null>(null);
  readonly pager = new CursorPaginationState();
  readonly searchCtrl = new FormControl('');
  readonly cols = ['employeeName', 'employeeCode', 'leaveType', 'allocated', 'used', 'balance'];
